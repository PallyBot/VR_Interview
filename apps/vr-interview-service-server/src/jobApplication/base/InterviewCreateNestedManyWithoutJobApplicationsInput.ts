...
@InputType()
class InterviewCreateNestedManyWithoutJobApplicationsInput {
...
export { InterviewCreateNestedManyWithoutJobApplicationsInput as InterviewCreateNestedManyWithoutJobApplicationsInput };
